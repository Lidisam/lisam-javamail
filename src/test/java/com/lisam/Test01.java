...
public class Test01 {
    ...
    //发件人地址
    public static String senderAddress = "lidisam@163.com";
    //收件人地址
    public static String recipientAddress = "364362035@qq.com";
    //发件人账户名
    public static String senderAccount = "lidisam@163.com";
    //发件人账户密码
    public static String senderPassword = "zandnpb3";
